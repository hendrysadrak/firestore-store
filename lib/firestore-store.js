...
module.exports = (expressSession) =>
	class FirestoreStore extends expressSession.Store {
		constructor(options) {
			...
			if (
				_options.database === undefined ||
				_options.database.collection === undefined
			)
				throw new Error("options.database is required");

			if (
				typeof _options.parser.read !== "function" ||
				typeof _options.parser.save !== "function"
			)
